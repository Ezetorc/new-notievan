  ...
  return (
    <div className='w-[300px] flex flex-col gap-y-2'>
      <header className='flex gap-2 mb-2'>
        <button
          type='button'
          className={`flex-1 py-2 px-4 clickable rounded-md font-semibold ${imageMode === 'file' ? 'bg-brand-orange text-white' : 'bg-gray-200'
            }`}
          onClick={() => {
            setImageMode('file')
            setImage('')
        ...
        <button
          type='button'
          className={`flex-1 py-2 px-4 clickable rounded-md font-semibold ${imageMode === 'url' ? 'bg-brand-orange text-white' : 'bg-gray-200'
            }`}
          onClick={() => {
            setImageMode('url')
            setImage('')
